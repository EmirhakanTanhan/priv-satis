...
<head>
    ...
    <script type="text/javascript">
        function FileSelected(file) {
            ...
            $(window.parent.document).find('#ResimBilgi').attr('style', "display:block; text-align: center");
            $(window.parent.document).find('#img' + Input).attr('src', file.fullPath);
            $(window.parent.document).find('#DosyaText').html(file.name);
            parent.ModalGizle('DosyaModal');
            console.log(file);
        }
    </script>
</head>
