                        ...
                        <div class="mb-5">
                            <?php if (!$Logs) { ?>
                                <div style="margin: 60px auto; text-align: center">
                                    ...
                                    <p style="text-align: center">Herhangi Bir Log Bulunmamaktadır.</p>
                                </div>
                            <?php } else { ?>
                                <table class="table table-hover" id="logs">
                                    <thead class="thead-default">
                                    <tr>
                                        <th style="width: 70px">Log No</th>
                                    ...
                                    foreach ($Logs as $log) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date_format(date_create($log['history']), "Y/m/d H:i:s"); ?></td>
                                            </td>
