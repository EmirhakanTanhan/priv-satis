                        ...
                        <div class="mb-5">
                            <?php if (!$Users) { ?>
                                <div style="margin: 60px auto; text-align: center">
                                    ...
                                    <p style="text-align: center">Herhangi Bir Üye Bulunmamaktadır.</p>
                                </div>
                            <?php } else { ?>
                                <table class="table table-hover" id="pages">
                                    ...
                                    foreach ($Users as $user) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date_format(date_create($user['history']), "Y/m/d H:i"); ?></td>
                                            <td>
                                                <a href="/panel/users/<?php echo $user['id'] ?>"
