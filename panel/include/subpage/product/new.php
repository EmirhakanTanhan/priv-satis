                                ...
                                <div class="form-row col-md-12">
                                    ...
                                    <div class="form-group col-md-2">
                                        <div id="stock_for_pnew" style="display: none">
                                            ...
                                            <div class="input-group">
                                                <input id="stock_input_for_pnew" type="number" step="1" class="form-control"
                                                       name="stock"
                                                       placeholder="0"/>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="alert alert-light" role="alert">
                                        ...
                                        <span id="stock_alert_auto"
                                              style="display: none"><strong>Otomatik Stok:</strong> Ürün için her bir stoğu, <a style="text-decoration: underline"
