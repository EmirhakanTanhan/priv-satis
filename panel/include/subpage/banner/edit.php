                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div id="ResimBilgi" class="mt-1"
                                                 style="text-align: center" <?php if (!$Banner['image']) echo 'style="display: none;"'; ?>>
                                                <img src="<?php echo $Banner['image'] ?>" id="imgDosya"
                                                     style="height: 120px;max-width: 300px;object-fit: contain"/>
                                                <p class="text-center" id="DosyaText"><?php echo substr($Banner['image'], strrpos($Banner['image'], '/') + 1); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
