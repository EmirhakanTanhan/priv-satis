        ...
        <div class="card">
            <div class="card-body">
                <div class="row" style="justify-content: space-between">
                    ...
                    <a href="/panel/banner/new" class="btn btn-dark yeni_duzenle_button">
                        ...
                        <div class="mb-5">
                            <?php if (!$Banners) { ?>
                                <div style="margin: 60px auto; text-align: center">
                                    ...
                                    <p style="text-align: center">Herhangi Bir Banner Bulunmamaktadır.</p>
                                </div>
                            <?php } else { ?>
                                <table class="table table-hover" id="banners">
                                    ...
                                    foreach ($Banners as $banner) {
                                        ?>
                                        <tr>
                                            <td><img src="<?php echo $banner['image'] ?>" alt=""
                                                     style="max-height: 100px"></td>
                                            <td><?php echo $banner['name'] ?></td>
                                            <td><?php echo $banner['link'] ?></td>
                                            <td>
                                                <span class="badge badge-<?php echo($banner['status'] ? "success" : "warning"); ?>"><?php echo($banner['status'] ? "Yayında" : "Yayında Değil"); ?></span>
                                            </td>
                                            <td>
                                                <a href="/panel/banner/edit/<?php echo $banner['id'] ?>"
                                                   class="btn btn-sm btn-light mr-2"><i class="fe fe-edit mr-2">
                                                    </i> Düzenle</a>
                                                <button onclick="Delete(<?php echo $banner['id'] ?>)" type="button"
    ...
    function Delete(id) {
        if (id) {
            swal(
                {
                    title: 'Emin misiniz?',
                    text: 'Bu banner silindiği zaman geri getirilemez!',
                    type: 'warning',
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        setTimeout(function () {
                            window.location.href = "/panel/banner/delete/" + id;
                        }, 1000);

                    } else {
                        swal({
                            title: 'İptal Edildi',
                            text: 'Banner silinmedi.',
                            type: 'error',
                            confirmButtonClass: 'btn-danger',
                        })
                    }
