        ...
        <div class="card">
            <div class="card-body">
                <div class="row" style="justify-content: space-between">
                    ...
                    <a href="/panel/products/new" type="button" class="btn btn-dark yeni_duzenle_button">
                        ...
                        <div class="mb-5">
                            ...
                            if (!$Products) { ?>
                                <div style="margin:auto; width: 317px">
                                    ...
                                    <p style="text-align: center">Herhangi Bir Ürün Bulunmamaktadır.</p>
                                </div>
                            <?php } else { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } else if ($product['discount']) { ?>
                                                    ...
                                                    <span style="margin-left: 5px">%<?php echo $product['discount'] ?></span>
                                                    <br>
                                                    <span><?php echo DiscountedPrice($product['price'], $product['discount']) . " TL" ?></span>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <span class="badge badge-<?php echo($product['status'] ? "success" : "warning"); ?>"><?php echo($product['status'] ? "Yayında" : "Yayında Değil"); ?></span>
                                            </td>
                                            <td>
                                                <a href="/panel/products/edit/<?php echo $product['id'] ?>"
                                                   class="btn btn-sm btn-light mr-2"><i class="fe fe-edit mr-2">
                                                    </i> Düzenle</a>
                                                <button onclick="Delete(<?php echo $product['id'] ?>)" type="button"
    ...
    function Delete(id) {
        if (id) {
            swal(
                {
                    title: 'Emin misiniz?',
                    text: 'Bu ürün silindiği zaman geri getirilemez!',
                    type: 'warning',
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        setTimeout(function () {
                            window.location.href = "/panel/products/delete/" + id;
                        }, 1000);
                    } else {
                        swal({
                            title: 'İptal Edildi',
