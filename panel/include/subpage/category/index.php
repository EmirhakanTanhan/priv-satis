        ...
        <div class="card">
            <div class="card-body">
                <div class="row" style="justify-content: space-between">
                    ...
                    <a href="/panel/category/new" type="button" class="btn btn-dark yeni_duzenle_button">
                        ...
                        <div class="mb-5">
                            <?php if (!$Categories) { ?>
                                <div style="margin: 60px auto; text-align: center">
                                    ...
                                    <p style="text-align: center">Herhangi Bir Kategori Bulunmamaktadır.</p>
                                </div>
                            <?php } else { ?>
                            <table class="table table-hover" id="pages">
                                ...
                                <tr>
                                    <th>Kategori Adı</th>
                                    <th style="width: 160px">Ürün Sayısı</th>
                                    <th style="min-width: 232px">İşlem</th>
                                </tr>
                                </thead>
                                ...
                                foreach ($Categories as $category) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $NumberOfCategories ?></td>
                                        <td>
                                            <a href="/panel/category/<?php echo $category['id'] ?>"
                                               class="btn btn-sm btn-light mr-2"><i class="fe fe-eye mr-2">
                                                </i> Gözat</a>
                                            <a href="/panel/category/edit/<?php echo $category['id'] ?>"
                                               class="btn btn-sm btn-light mr-2"><i class="fe fe-edit mr-2">
                                                </i> Düzenle</a>
                                            <button onclick="Delete(<?php echo $category['id'] ?>)" type="button"
    ...
    function Delete(id) {
        if (id) {
            swal(
                {
                    title: 'Emin misiniz?',
                    text: 'Bu kategori altındaki bütün ürünler, kategori ile beraber silinecek. Bu işlemi geri alamazsınız!',
                    type: 'warning',
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        setTimeout(function () {
                            window.location.href = "/panel/category/delete/" + id;
                        }, 1000);
                    } else {
                        swal({
                            title: 'İptal Edildi',
