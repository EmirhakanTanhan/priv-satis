        ...
        <div class="card">
            <div class="card-body">
                <div class="row" style="justify-content: space-between">
                    <h1 class="mb-4 ml-3">
                        <strong>Stok Ürünleri</strong>
                    </h1>
                    <a href="/panel/stocks/new" type="button" class="btn btn-dark yeni_duzenle_button">
                        ...
                        <div class="mb-5">
                            <?php if (!$Stock) { ?>
                                <div style="margin: 60px auto; text-align: center">
                                    ...
                                    <p style="text-align: center">Herhangi Bir Stok Ürünü Bulunmamaktadır.</p>
                                </div>
                            <?php } else { ?>
                            <table class="table table-hover" id="products">
                                ...
                                foreach ($Stock as $stock) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $stock['image']; ?>" alt="" style="max-height: 70px">
                                        </td>
                                        <td><?php echo $stock['name']; ?></td>
                                        <td><?php echo date_format(date_create($stock['history']),"Y/m/d H:i"); ?></td>
                                        <td><?php echo Category($stock['Category_id']); ?>
                                        </td>
                                        <td>
                                            <span class="badge badge-<?php if ($stock['status'] == "0") {
                                                echo "warning";
                                            }
                                            if ($stock['status'] == "1") {
                                                echo "success";
                                        ...
                                        <td>
                                            <a href="/panel/stocks/edit/<?php echo $stock['id'] ?>"
                                               class="btn btn-sm btn-light mr-2"><i class="fe fe-edit mr-2">
                                                </i> Düzenle</a>
                                            <button onclick="Delete(<?php echo $stock['id'] ?>)" type="button"
            ...
            swal(
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        setTimeout(function () {
                            window.location.href = "/panel/stocks/delete/" + id;
                        }, 1000);
