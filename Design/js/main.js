$(document).ready(function () {
	...
	//previousTop - currentTop > scrollDelta         							removeClass
	//currentTop - previousTop > scrollDelta && currentTop > scrollOffset		addClass
	function checkSimpleNavigation(currentTop) {
		if (currentTop < 140) {
			mainHeader.removeClass('header--scroll');
		} else if (currentTop > 140) {
	...
	Modal
	==============================*/
	$('.post__video, .details__trailer').magnificPopup({
		disableOn: 700,
